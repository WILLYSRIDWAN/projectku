...
// Simulasi login (gunakan database di sini jika perlu)
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Username dan password yang dimasukkan
    $username = $_POST['username'];
    $password = $_POST['password'];

    // Validasi login (ini hanya contoh, ganti dengan validasi dari database)
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        ...
        <img src="./img/logo stikom.png" alt="" width="70p" height="70"  style="border-radius: 50%;">
